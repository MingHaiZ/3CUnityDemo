...
public class GlidingPlayerState : PlayerState
{
    ...
    protected override void OnStep(Player player)
    {
        ...
        player.FaceDirection(player.lateralVelocity, player.stats.current.rotationSpeed);
        player.Accelerate(inputDirection, player.stats.current.glidingTurningDrag, player.stats.current.airAcceleration,
